...
CommandPlayerLive::CommandPlayerLive( SIncomingCommandServices * _services )
    : ICommandExternal(_services)
{

}

bool CommandPlayerLive::exec(){
    ...
    if( userHasPermission(m_userId, (SIncomingCommandServices *)m_services, errMsg) ){
        ...
        if( player ){
            ...
            Json::Value rootRecord;
            rootRecord[ "cmd_name" ] = "player_live";
