...
#include "system_environment_facade_player.h"
...
SystemEnvironmentFacadePlayer::SystemEnvironmentFacadePlayer()
{
...
bool SystemEnvironmentFacadePlayer::init( const SInitSettings & _settings ){
